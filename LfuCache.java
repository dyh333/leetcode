...
import leetcode.editor.cn.LruCache.LRUCache;
...
public class LfuCache {
    ...
    class LFUCache {
        ...
        private void increaseFreq(int key) {
            ...
            // dingyihui: putIfAbsent函数会判断key是否已存在，若已存在则不执行put操作
